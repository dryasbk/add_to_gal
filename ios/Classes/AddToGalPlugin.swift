...
public class AddToGalPlugin: NSObject, FlutterPlugin {

    public static func register(with registrar: FlutterPluginRegistrar) {
        let channel = FlutterMethodChannel(name: "add_to_gal", binaryMessenger: registrar.messenger())
        let instance = AddToGalPlugin()
    ...
    public func handle(
        ...
        if call.method == "addImageToGal" {
            self.addToAssetCollection(call, result)
        } else if call.method == "addVideoToGal" {
